...
\begin{itemize}
    ...
    \item \textbf{Expert evaluation}: Analysis of the responses generated by the RAG system during internal testing deployments, focusing on accuracy, relevance, and source attribution.
    \item \textbf{Technical performance metrics}: Quantitative measures of token usage, response latency, embedding generation time.
\end{itemize}
