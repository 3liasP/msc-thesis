...
% Using cite to reference articles and publicationRef to link to attached papers.

\cite{article1}
\cite{article2}
\cite{article3}

\publicationRef{article1}

\publicationRef[Other Supplement]{article1}

%%%%% Bibliography/references.

%%%%%%%% % % % Joonas edits % % % %%%%%%%%%
\newrefcontext[labelprefix=P]
\printbibliography[prenote=pubs2thesis,category={ThesisPublications}]
...
\printbibliography[heading=bibintoc,notcategory={ThesisPublications}]
